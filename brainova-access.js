/* ===========================================================
   🌐 BRAINOVA ACCESS CONTROL SYSTEM – v2.4 (Production Clean)
   🔹 Gestion propre & stable des accès Jeux (Gratuits / Premium)
   🔹 Bordure jaune uniquement sur jeux Premium
   🔹 Bannière unique, cadenas fixes, statut persistant
   🔹 Compatible Stripe + Netlify + Brevo
   🔹 Auteur : GPT-5 Assistant (Production Brainova)
   =========================================================== */

console.log("🚀 Initialisation du module Brainova Access v2.4...");
...
// --- Synchronisation avec Netlify (mock API) ---
...
// --- Style bordure jaune Premium ---
function applyPremiumBorder(card) {
  if (!card) return;
  card.style.outline = "3px solid #FFD700"; // or vif doré
...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  await new Promise(r => setTimeout(r, 800)); // attendre rendu de la grille
